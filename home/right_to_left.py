...
As a joke on the right handed robots, you should replace all cases of the words "right" with the word "left", even if it's a part of another word. All strings are given in lowercase.
...
def left_join(phrases: tuple) -> str:
    ...
    """
    return ','.join(list(map(lambda elem: elem.replace('right' , 'left'), phrases)))
